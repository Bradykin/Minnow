...
public static class GameMetaprogressionUnlocksDataManager
{
    ...
    private static void AddCardRewards()
    {
        ...
        m_cardRewards.Add(3, CreateCardLevelReward("Spellcraft",
            "<b>Spellcraft</b> triggers whenever a spell is cast within range 3 of the unit with <b>Spellcraft</b>!",
            new ContentFishOracleCard(), new ContentInsightCard(), new ContentRunicBladeCard()));

        m_cardRewards.Add(4, CreateCardLevelReward("Shivs",
        ...
        m_cardRewards.Add(5, CreateCardLevelReward("Creations",
        ...
        m_cardRewards.Add(6, CreateCardLevelReward("Max Stamina",
