...
public class ContentSymbolOfTheAllianceRelic : GameRelic
{
    public ContentSymbolOfTheAllianceRelic()
    {
        ...
        m_desc = "When you summon a unit, if you control a <b>Humanoid</b>, <b>Monster</b>, and <b>Creation</b> unit already, give it <b>Damage Reduction 2</b>.  (The unit played does not count)";
