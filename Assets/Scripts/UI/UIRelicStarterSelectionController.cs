...
public class UIRelicStarterSelectionController : Singleton<UIRelicStarterSelectionController>
{
    ...
    void Start()
    {
        ...
        m_starterRelics[1].Init(new ContentWolvenFangRelic(), UIRelic.RelicSelectionType.SelectStarter);
        ...
        m_starterRelics[4].Init(new ContentHoovesOfProductionRelic(), UIRelic.RelicSelectionType.SelectStarter);
    }
}
